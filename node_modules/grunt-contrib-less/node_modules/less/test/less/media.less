...
@media a {
	.first {@media b {.second { .third { width:300px;@media c {width:  500px
		;
...
body {@media a,b and c {width:  95%; @media x,y {width:  100%;
...
.nav-justified {@media (min-width : 480px) { > li {
	display: table-cell;
}

}
}
.menu {@media (min-width : 768px) {.nav-justified ();
