...
#relative-url-import { .unquoted-relative-path-bg; .quoted-relative-path-border-image;
...
.add_an_import (@file_to_import) {@import "@{file_to_import}";
...
#svg-functions {
	...
	orange_percentage: 3%; @
	orange_color: orange;
	background-image: svg-gradient(to bottom, ( mix(black, white)+  #444) 1%,@orange_color@orange_percentage,((@green_5)),
		white 95%);
}
